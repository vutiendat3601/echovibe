...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">Echo Vibe - Admin is an application template for Angular and is distributed as a CLI project. Current versions is Angular v19 with PrimeNG v19. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
<code>npm install -g &#64;angular/cli</code></pre>
            ...
            <pre class="app-code">
<code>git clone https://github.com/primefaces/echovibe-ui-admin-ng
npm install
ng serve</code></pre>
