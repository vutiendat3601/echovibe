...
def handle_artist_created_event(artist_created_event: ArtistCreatedEvent):
...
def handle_artist_released_event(artist_released_event: ArtistReleasedEvent):
...
def handle_artist_updated_event(artist_updated_event: ArtistUpdatedEvent):
    updated_at = datetime.now(timezone.utc)
    artist = artist_repository.find_by_aggregate_id_and_is_active_true(
...
def handle_artist_deleted_event(artist_deleted_event: ArtistDeletedEvent):
    updated_at = datetime.now(timezone.utc)
