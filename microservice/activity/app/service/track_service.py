...
class TrackService:
    ...
    def handle_like_track_action(self, activity: Activity) -> dict[str, str]:
    ...
    def handle_listened_track_action(self, session_id: str) -> dict[str, str]:
    ...
    def handle_viewed_track_detail_page_action(
